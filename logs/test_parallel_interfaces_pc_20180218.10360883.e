...
++ date +%Y%m%d_%H%M%S
+ export DATE=20180218_211055
+ DATE=20180218_211055
+ ulimit -n 20000
+ ulimit -u 20000
+ srun -N 64 -n 2048 -c 2 --cpu_bind=cores python test_parallel_interfaces.py --framework=pc
...
Traceback (most recent call last):
  ...
  File "test_parallel_interfaces.py", line 9, in test
    if 'count' not in context_monkeys():
  File "/global/homes/a/aaronmil/python_modules/nested/utils.py", line 212, in __call__
    keys = dir(self)
...
0  ^
        0 ParallelContext[0].working()
Traceback (most recent call last):
  File "test_parallel_interfaces.py", line 68, in <module>
  ...
  File "test_parallel_interfaces.py", line 51, in main
...
RuntimeError: hoc error
slurmstepd: error: *** STEP 10360883.0 ON nid00541 CANCELLED AT 2018-02-18T21:41:26 DUE TO TIME LIMIT ***
srun: got SIGCONT
srun: got SIGCONT
